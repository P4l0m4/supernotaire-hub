import { a as _export_sfc, b as __nuxt_component_0, _ as __nuxt_component_0$3, c as __nuxt_component_1$1, f as useNuxtApp, u as useState, e as __nuxt_component_1$1$1, d as colors, j as __nuxt_component_2$1 } from './server.mjs';
...
import { defineComponent, withCtx, createVNode, createTextVNode, reactive, ref, watch, unref, isRef, useSSRContext } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (showFirstAction.value) {
        _push(`<div class="action" data-v-385f7468><div class="location" data-v-385f7468><label for="location-form-input" class="location-label" data-v-385f7468>Adresse du bien \xE0 estimer`);
        ...
        _push(ssrRenderComponent(_component_FormElementsInputField, {
          ...
          type: "text",
          required: true,
          placeholder: "Commencez \xE0 taper une adresse..."
        }, null, _parent));
      ...
      if (showLastAction.value) {
        _push(`<div class="action" data-v-385f7468>`);
        if (dvfLoading.value) {
          ...
          _push(`<!--[--><div class="action__illustration" data-v-385f7468><img class="action__illustration__image"${ssrRenderAttr("src", unref(achievement))} alt="Avant de partir" data-v-385f7468></div><ul class="action__list" data-v-385f7468><span class="action__list__title" data-v-385f7468>${ssrInterpolate((_a3 = (_a2 = valuation.value.estimatedValue) == null ? void 0 : _a2.toLocaleString("fr-FR")) != null ? _a3 : "N/A")} \u20AC</span><span class="action__list__subtitle" data-v-385f7468>D\xE9tails de l&#39;estimation :</span><li class="action__list__item" data-v-385f7468> Valeur de base (hors d\xE9cote/surcote): ${ssrInterpolate((_c = Math.round((_b2 = valuation.value.marketValue) != null ? _b2 : 0).toLocaleString("fr-FR")) != null ? _c : "N/A")} \u20AC </li><li class="action__list__item" data-v-385f7468> Prix moyen/m\xB2: ${ssrInterpolate((_e = Math.round((_d = valuation.value.avgPricePerSqm) != null ? _d : 0).toLocaleString("fr-FR")) != null ? _e : "N/A")} \u20AC </li>`);
          if (valuation.value.landValue && valuation.value.landValue > 0) {
            _push(`<!--[--><li class="action__list__item" data-v-385f7468> Valeur du terrain seul: ${ssrInterpolate(Math.round(valuation.value.landValue).toLocaleString("fr-FR"))} \u20AC </li><li class="action__list__item" data-v-385f7468> Valeur du bien + terrain: <strong data-v-385f7468>${ssrInterpolate((_h = Math.round(
          ...
          _push(`<div class="action__list__buttons" data-v-385f7468>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-385f7468"]]);
...
//# sourceMappingURL=valeur-fonciere-CxVh725Z.mjs.map
