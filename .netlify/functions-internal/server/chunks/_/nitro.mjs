...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "20f47cb1-ec1e-4b5c-b0b9-483e3340e1ab",
...
const _apTB_h7qoAiRRRoNm6SKWsShFYciQhZ58mwlIJAz7o = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _apTB_h7qoAiRRRoNm6SKWsShFYciQhZ58mwlIJAz7o
];
...
const _mPec1t = eventHandler(async (e) => {
...
const _JpuNH2 = defineEventHandler(async (e) => {
...
const _wGFQQZ = defineEventHandler(async (e) => {
...
const _lazy_UXfdbw = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_UXfdbw, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _mPec1t, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _JpuNH2, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _wGFQQZ, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_UXfdbw, lazy: true, middleware: false, method: undefined }
];
